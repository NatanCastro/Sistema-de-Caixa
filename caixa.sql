-- --------------------------------------------------------
-- Servidor:                     C:\Users\User\bin\produto-curso\caixa.sqlite3
...
INSERT INTO "itens_venda" ("id_venda", "codigo_produto", "quantidade", "valor_unit", "valor_total") VALUES
	(1, '123', 1, 20.0, 20.0),
	(1, '456', 2, 60.0, 120.0);
...
INSERT INTO "produto" ("codigo_barras", "nome", "valor_produto", "valor_venda", "margem_lucro", "quantidade", "ativo", "id_categoria") VALUES
	('123', 'camisa', '10,00', '20,00', '50', 9, 1, 1),
	('456', 'blusa', '30,00', '60,00', '50', 8, 1, 1),
...
INSERT INTO "venda" ("id", "id_cliente", "id_usuario", "id_metodo_pagamento", "valor_total", "desconto", "valor_final", "data_venda") VALUES
	(1, 1, 1, 4, 140.0, 0.0, 140.0, '2023-02-15');
